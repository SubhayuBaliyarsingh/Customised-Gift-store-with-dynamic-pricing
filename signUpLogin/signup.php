...
<body>
    <div class="container" id="container">
        <div class="form-container sign-up">
            <form action="processSignUp.php" method="POST" id="signupForm">
                ...
                <p class="redirect-text">Already have an account? <a href="login.php">Log In</a></p>
            </form>
        </div>
        <div class="toggle-container">
            <div class="toggle">
                <div class="toggle-panel toggle-left">
                    ...
                    <a href="login.php"><button type="button" class="hidden">Log In</button></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <?php if ($error_message): ?>
    <script>
        alert('Registration Error: <?php echo addslashes($error_message); ?>');
    </script>
    <?php endif; ?>
</body>
